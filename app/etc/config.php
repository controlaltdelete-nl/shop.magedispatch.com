...
return [
    ...
    'scopes' => [
        'websites' => [
            ...
            'threedprintentexel_nl' => [
                'website_id' => '2',
                'code' => 'threedprintentexel_nl',
                'name' => '3D Printen Texel.nl',
                'sort_order' => '0',
                'default_group_id' => '2',
                'is_default' => '0'
            ]
        ...
        'groups' => [
            ...
            [
                'group_id' => '2',
                'website_id' => '2',
                'name' => '3D Printen Texel Store',
                'root_category_id' => '2',
                'default_store_id' => '2',
                'code' => 'threedprintentexel_nl_store'
            ]
        ],
        'stores' => [
            'admin' => [
            ...
            'threedprintentexel_dutch' => [
                'store_id' => '2',
                'code' => 'threedprintentexel_dutch',
                'website_id' => '2',
                'group_id' => '2',
                'name' => '3dprintentexel.nl',
                'sort_order' => '1',
                'is_active' => '1'
            ]
        ]
